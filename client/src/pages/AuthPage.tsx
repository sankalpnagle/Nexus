      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-[var(--nx-bg)] border-r border-[var(--nx-border)] p-12 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-2xl font-black text-[var(--nx-heading)] font-[var(--font-display)] tracking-tight">Nexus</span>
          </div>
          <p className="text-[var(--nx-muted)] text-sm">Social platform for the modern web.</p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <div className="w-10 h-10 rounded-xl bg-[#7c6ff7] flex items-center justify-center">
              <span className="text-[var(--nx-bg)] font-black text-lg font-[var(--font-display)]">N</span>
            </div>
            <span className="text-xl font-black text-[var(--nx-heading)] font-[var(--font-display)]">Nexus</span>
          </div>
