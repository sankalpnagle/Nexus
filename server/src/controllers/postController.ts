...
export const toggleLike = async (
  ...
  try {
    ...
    const updatedLikes = updated?.likes.map(String) ?? [];
...
export const addComment = async (
  ...
  try {
    ...
    const commenterId = me._id.toString();
    emitEvent("post:commented", {
      postId,
      comment: newComment,
      authorId,
      commenterId,
...
export const deletePost = async (
  ...
  try {
    ...
    emitEvent("post:removed", { postId: req.params.postId });
